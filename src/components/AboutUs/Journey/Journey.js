      ...
      <div className="journey">
        <div className='container'>
          <div className="innerSection" data-aos="fade-right"
            ...
            data-aos-duration="1000">
                <h2>Start Your Journey with Quick Growth</h2>
                <p>Embark on a transformation journey into the future of innovation as you kickstart your exploration of
                Power AI, where limitless possibilities await at every click and command.</p>
                <div className="btns">
